const statesWithTaxList = [
    ...
    { name: "Alaska", taxRate: 0.0 }, // No state sales tax, but localities can impose their own.
    ...
    { name: "Delaware", taxRate: 0.0 }, // Delaware does not have a sales tax.
    { name: "Florida", taxRate: 6.0 },
    { name: "Georgia", taxRate: 4.0 },
    { name: "Hawaii", taxRate: 4.0 }, // General Excise Tax (GET)
    ...
    { name: "Minnesota", taxRate: 6.875 },
    { name: "Mississippi", taxRate: 7.0 },
    { name: "Missouri", taxRate: 4.225 },
    { name: "Montana", taxRate: 0.0 }, // Montana does not have a sales tax.
    { name: "Nebraska", taxRate: 5.5 },
    { name: "Nevada", taxRate: 6.85 },
    { name: "New Hampshire", taxRate: 0.0 }, // New Hampshire does not have a sales tax.
    { name: "New Jersey", taxRate: 6.625 },
    { name: "New Mexico", taxRate: 5.125 },
    ...
    { name: "Oregon", taxRate: 0.0 }, // Oregon does not have a sales tax.
