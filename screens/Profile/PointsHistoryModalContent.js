  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        {isExpanded && (
          <>
            ...
            <Text>
              Every time you shop online in store, you'll earn points. $1.00 = 1 points
            </Text>
            <Text style={styles.thereMoreText}>And there's more!</Text>
            <Text>
                From time to time, you can earn extra points on your purchases - so keep an eye out!
            </Text>
          </>
        )}
      </TouchableOpacity>
      <View style={isExpanded ? styles.expandedContainer3 : styles.container3}>
        ...
        <Text style={styles.text4}>Take a look under Points to find out more.</Text>
      </View>
    </View>
  );
};
